...
Stability occurs when $|G|\leq1$ and (@eq-lax-method-inviscid-burgers-amplification-factor) reduces down to
...
The Lax-Wendroff method was one of the first second order finite difference methods derived for hyperbolic PDEs. Once again, we consider the general form of the governing (@eq-general-hyperbolic-pde). The Lax-Wendroff method is
