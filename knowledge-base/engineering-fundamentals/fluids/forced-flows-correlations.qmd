...
$$
\mathrm{Nu}_x=0.3317\mathrm{Re}_x^{1/2}\mathrm{Pr}^{1/3}\tag{5.4.16}
$$

**Analytical:** Smooth surface, uniform wall temperature with an adiabatic segment of length $\xi$, no wall injection

$$
\mathrm{Nu}_x=0.3317\mathrm{Re}_x^{1/2}\mathrm{Pr}^{1/3}\left[1-\left(\frac {\xi}x\right)^{3/4}\right]^{-1/3}\tag{5.4.19}
$$

**Analytical:** Smooth surface, uniform heat flux with an adiabatic segment of length $\xi$, no wall injection

$$
\mathrm{Nu}_x=0.418\mathrm{Re}_x^{1/2}\mathrm{Pr}^{1/3}\left(1-\frac {\xi}x\right)^{-1/3}\tag{5.4.21}
$$
