...
All correlations for natural convection on vertical flat surfaces are applicable provided that $g$ is replaced with $g\cos\phi$, where $\phi$ is the inclination angle from the vertical, for all of these models. See @sec-natural-vertical-plate-heat-transfer-coefficient-turbulent for relevant correlations.
...
**Yovanovich (1987):** Reference @fig-yovanovich-submerged-bodies-geometries for submerged body geometries, valid for $\mathrm{Ra}_{l_c}<10^8$, characteristic length $l_c=\sqrt A$ where $A$ is the total surface area.

![](assets/yovanovich-submerged-bodies-geometries.png){#fig-yovanovich-submerged-bodies-geometries .lightbox}
...
See @tbl-yovanovich-submerged-bodies-geometries for $G_{l_c}$ and $\langle\mathrm{Nu}_{l_c}\rangle_{\mathrm{Ra}_{l_c}\to0}$.
...
: Correlation coefficients for submerged bodies {#tbl-yovanovich-submerged-bodies-geometries}
